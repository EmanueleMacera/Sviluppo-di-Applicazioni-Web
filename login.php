...
<head>
    ...
    <style>
        ...
        #navbarResponsive .nav-link {
            background-color: rgb(163, 145, 84);
            font-size: 12.4px;
            border-radius: 28px;
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
    ...
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="index.php">Stema</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="text-uppercase section-heading">LOG IN</h2>
                    <h3 class="text-muted section-subheading">Complete the form</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <form id="loginForm" name="loginForm" novalidate="novalidate" method="POST" action="database/login.php">
                        <div class="row">
                            <div class="col-md-12">
                                <input class="form-control" type="email" id="email" placeholder="E-mail" required="" name="email" maxlength="50">
                                <div id="emailError"></div>
                            </div>
                            <div class="col-md-12">
                                <input class="form-control" type="password" id="pass" placeholder="Password" required="" name="pass" maxlength="25">
                                <div id="passError"></div>
                            </div>
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-xl text-uppercase" id="submit" type="submit" name="submit">LOG IN</button>
                                <div id="logSucc"></div>
                            </div>
                        </div>
                    </form>
