...
<head>
    ...
    <style>
        ...
        #navbarResponsive .nav-link.signup {
            background-color: rgb(234, 183, 9);
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item"><a class="nav-link signup" href="registration.php">Sign Up</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="masthead">
        <div class="container">
            <div class="intro-text">
                <span style="font-size: 63px;font-weight: bold;">WELCOME TO STEMA WORLD'S</span>
                <div class="intro-lead-in"><span>It's nice to meet you!</span></div>
    ...
    <section id="about" style="padding: 80px 0px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
